...
class ClassificationAccuracy():
    ...
    def compute_acc(self,
        ...
        # dataset = TensorDataset(attack_imgs, targets)
        acc_top1 = Accuracy()
        ...
        with torch.no_grad():
            for step, (img_batch, target_batch) in enumerate(loader):
                img_batch, target_batch = img_batch.to(self.device), target_batch.to(self.device)
                ...
                output = self.evaluation_network(img_batch)
